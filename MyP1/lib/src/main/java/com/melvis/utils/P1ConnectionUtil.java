...
public class P1ConnectionUtil {
	...
	public static Connection getConnection() throws SQLException {
		...
		//Hard coded for now... BAD! we'll change this later to hide them in the Environment Variables
		
		//I'm going to put the credentials in Strings, and use those strings in a method that gets connections
		String url = "jdbc:postgresql://localhost:5432/postgres?currentSchema=reimbursement";//change the schema in your projects
		String username = "postgres"; //Never changes
		String password = "Mummy01Daddy02";//input the password you used in postgres
